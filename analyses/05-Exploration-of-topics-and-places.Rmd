...
identify numbers of papers relevant to each topic. The tokens to search for are stored in /data/derived-data/coding/keyword-matches/keyword-search-tokens.csv. These keyword occurrences are extracted using the code ross_keyword_extract.R. 
