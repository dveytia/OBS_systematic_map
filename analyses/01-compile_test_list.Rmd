...
# number of test list articles -- 105
nrow(screened_test_list)

```

```{r write dois of test list articles}

# cat(paste0(screened_test_list$doi, collapse = " OR "), 
#     file = here::here("data", "derived-data", "screen_test_list", "test-list_screened_dois.txt"))
...
# # # write to excel
# writexl::write_xlsx(test_list, here::here("data", "derived_data", "screen_test_list", 
#                     "test-list_2023-01-19.xlsx"))

# ## write to text file
# cat(paste0(test_list$doi, collapse = " OR "), 
