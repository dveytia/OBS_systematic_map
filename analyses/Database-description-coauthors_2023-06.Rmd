...
dedups <- tbl(all_db, "uniquerefs") %>% 
  select(analysis_id, duplicate_id, title) %>% collect
...
We can next look at what the predicted relevance was for all the three branches, compared to what branch was selected:
