...
codebookCombinedSimplifiedMore <- simplifyCodebook2(codebookCombinedSimplified,idCols)
...
varPriority <- varPriority[,c("Variable name","Cluster 4")]
colnames(varPriority) <- c("variable","cluster")
...
clusterCounts <- clusterCounts %>%
  filter(variable != "oro_branch")
clusterCounts$cluster <- as.factor(clusterCounts$cluster)
clusterCounts <- clusterCounts%>%
  arrange(cluster)%>%
...
gridExtra::grid.arrange(ggps[[5]],ggps[[6]],ggps[[7]],ggps[[8]],ggps[[9]], nrow=3)
