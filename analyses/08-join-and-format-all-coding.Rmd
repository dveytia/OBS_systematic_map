...
write.csv(responseDf[,1:6], 
          here::here("data","derived-data","coding","manual-coding","coding-screening_combined-formatted_sets.csv"),
          row.names = FALSE)
...
```{r read in all articles screened}

## From initial round 
codingScreen0 <- read.csv(
  here::here("data","derived-data","coding","manual-coding","set-0_check", "coding-screening_combined-formatted_set-0.csv"))
