...
```{r using the dedeuplicated sample of references create files to upload for screening}
...
# from this, divide into sets of articles to screen based on block
sampleInstructions <- data.frame(
  source_string = unique(unique_wos_results$source_string),
  n = c(1000, 700, 1000, 300, 1000)
)

# using the sample instructions create a dataframe with a random sample
